...
impl Default for VoiceConfig {
    fn default() -> Self {
        let pill_bg = [0.113, 0.113, 0.113, 0.456];
        Self {
            enabled: true,
            ...
            horz_edge_padding: 5,
            overflow: 0,
            order: AvatarOrder::Alphabetical,
            only_speaking: false,
